...
Ka = values[1]*(1-values[4]) + values[3]*values[4]
variable_name = [ 'ths', 'Ks', 'thFr', 'KsFr', 'W', 'Bulkd', 'DisperL', 'DisperT', 'ThImob',
                 'DispF','Alfa']
